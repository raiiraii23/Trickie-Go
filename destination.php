                ...
                ?>
                  ...
                  <div class="form-group my-2">
                      <div class="input-group">
                        ...
                        <strong ><?= isset($destination) ? $destination : 'Add' ?>
                        </strong>
                      </div>
                    </div>
                              ...
                              <div class="form-group my-2">
                                <div class="input-group">
                                  ...
                                  <select class="form-select" name="destination" aria-label="Select Role">
                                    ...
                                    <option value="Block 5" <?php echo (isset($destination) === 'Block 5') ? 'selected' : ''; ?> >Block 5</option>
                                    <option value="Block 6" <?php echo (isset($destination) === 'Block 6') ? 'selected' : ''; ?> >Block 6</option>
                                    <option value="Block 7" <?php echo (isset($destination) === 'Block 7') ? 'selected' : ''; ?> >Block 7</option>
                                    <option value="Block 8" <?php echo (isset($destination) === 'Block 8') ? 'selected' : ''; ?> >Block 8</option>
                                    <option value="Block 9" <?php echo (isset($destination) === 'Block 9') ? 'selected' : ''; ?> >Block 9</option>
                                    <option value="Block 10" <?php echo (isset($destination) === 'Block 10') ? 'selected' : ''; ?> >Block 10</option>
                                    <option value="Block 11" <?php echo (isset($destination) === 'Block 11') ? 'selected' : ''; ?> >Block 11</option>
                                    <option value="Block 12" <?php echo (isset($destination) === 'Block 12') ? 'selected' : ''; ?> >Block 12</option>
                                    <option value="Block 13" <?php echo (isset($destination) === 'Block 13') ? 'selected' : ''; ?> >Block 13</option>
                                    <option value="Block 14" <?php echo (isset($destination) === 'Block 14') ? 'selected' : ''; ?> >Block 14</option>
                                    <option value="Block 15" <?php echo (isset($destination) === 'Block 15') ? 'selected' : ''; ?> >Block 15</option>
                                    <option value="Block 16" <?php echo (isset($destination) === 'Block 16') ? 'selected' : ''; ?> >Block 16</option>
                                    <option value="Block 17" <?php echo (isset($destination) === 'Block 17') ? 'selected' : ''; ?> >Block 17</option>
                                    <option value="Block 18" <?php echo (isset($destination) === 'Block 18') ? 'selected' : ''; ?> >Block 18</option>
                                    <option value="Block 19" <?php echo (isset($destination) === 'Block 19') ? 'selected' : ''; ?> >Block 19</option>
                                    <option value="Block 20" <?php echo (isset($destination) === 'Block 20') ? 'selected' : ''; ?> >Block 20</option>
                                    <option value="Block 21" <?php echo (isset($destination) === 'Block 21') ? 'selected' : ''; ?> >Block 21</option>
                                    <option value="Block 22" <?php echo (isset($destination) === 'Block 22') ? 'selected' : ''; ?> >Block 22</option>
                                    <option value="Block 23" <?php echo (isset($destination) === 'Block 23') ? 'selected' : ''; ?> >Block 23</option>
                                    <option value="Block 24" <?php echo (isset($destination) === 'Block 24') ? 'selected' : ''; ?> >Block 24</option>
                                    <option value="Block 25" <?php echo (isset($destination) === 'Block 25') ? 'selected' : ''; ?> >Block 25</option>
                                    <option value="Block 26" <?php echo (isset($destination) === 'Block 26') ? 'selected' : ''; ?> >Block 26</option>
                                    <option value="Block 27" <?php echo (isset($destination) === 'Block 27') ? 'selected' : ''; ?> >Block 27</option>
                                  </select>
                                </div>
                              </div>
              ...
              if ($role == "passenger" ) {
                  ...
                  <div class="form-group my-2">
                      <div class="input-group">
                        <span class="input-group-addon mx-2"><i class="fa fa-map"></i></span>
                        <span class="px-2">Destination: </span>
                        <strong ><?= !empty($destination) ? $destination : 'Add' ?>
                        </strong>
                      </div>
                    </div>
                    ...
                    <div class="form-group my-2">
                      <div class="input-group">
                        ...
                        <span class="px-2">How many are you?</span>
                        <strong ><?= !empty($count_passenger) ? $count_passenger : '0' ?>
                      </div>
                    </div>
                    
                    <div class="form-group text-center my-2">
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" data-passenger="<?= $count_passenger ?>" data-destination="Block 5  ">
                    <?= !empty($count_passenger)  ? 'Edit' : "Add"; ?>
                    </button>
                          ...
                          <div class="modal-body">
                            <form id="" method="POST">
                              ...
                              <div class="form-group my-2 ">
                                <div class="input-group">
                                  <span class="input-group-addon mx-2"><i class="fa fa-users"></i></span>
                                  <input type="number" class="form-control passenger-count" name="passenger-count" min="1" max="5" placeholder="<?= !empty($count_passenger) ? $count_passenger : '0' ?>" required="required" autocomplete="on">
                                </div>
                              </div>
